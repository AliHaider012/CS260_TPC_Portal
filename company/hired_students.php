...
$sql = "SELECT * FROM hiring NATURAL JOIN Student where cid='$user_id'";
                            ...
                            <table id="filter" class="table">
                                ...
                                <tbody>
                                    <?php while ($row = mysqli_fetch_assoc($result)) {
                                        echo "<tr><td>" . $row['roll_no'] . "</td><td>" . $row['name'] . "</td><td>" . $row['field'] . "</td><td>" . $row['salary'] . "</td><td>" . $row['year'] . "</td></tr>";
                                    } ?>
                                </tbody>
                            </table>

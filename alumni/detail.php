                            ...
                            <table id="filter" class="table">
                                ...
                                <tbody>
                                    <?php while ($row = mysqli_fetch_assoc($result)) {
                                        echo "<tr><td>" . $row['roll_no'] . "</td><td>" . $row['name'] . "</td><td>" . $row['email'] . "</td><td>" . $row['program'] . "</td><td>" . $row['branchcode'] . "</td><td><a href=\"documents.php\" onclick=\"event.preventDefault(); document.getElementById('roll_no').value='" . $row['roll_no'] . "';  document.getElementById('form').submit();\">View</a></td></tr>";
                                    } ?>
